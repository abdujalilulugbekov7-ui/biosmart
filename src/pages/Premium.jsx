          ...
          <div className="checkout-action-box">
            {isPro ? (
              ...
              <div className="checkout-purchase-actions">
                ...
                >
                  PRO Obunani Faollashtirish ({plans[selectedPlan].price}) ⚡
                </button>
                <p className="disclaimer-text">
                  <FiInfo /> Bosish orqali siz foydalanish shartlariga rozilik bildirasiz. Click orqali xavfsiz to'lov shlyuzi ulanadi.
                </p>
              </div>
            )}
          </div>
